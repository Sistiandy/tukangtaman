        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">
                    <img src="<?php echo media_url() ?>/img/logo.png" class="navbar-brand-logo " alt="" />
                </a>
            </div>
        ...
        <div id="carousel-example" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    ...
                    <img src="<?php echo media_url() ?>/img/1.jpg" alt="" />
                ...
                <div class="item">
                    <img src="<?php echo media_url() ?>/img/2.jpg" alt="" />
                    <div class="carousel-caption ">
                ...
                <div class="item">
                    <img src="<?php echo media_url() ?>/img/3.jpg" alt="" />
                    <div class="carousel-caption ">
                                ...
                                <div class="container center">
                                    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 slide-custom">
                                        ...
                                        <div class="user-img pull-right">
                                            <img src="<?php echo media_url() ?>/img/user.gif" alt="" class="img-u image-responsive" />
                                        </div>
                            ...
                            <div class="item">
                                <div class="container center">
                                    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 slide-custom">
                                        ...
                                        <div class="user-img pull-right">
                                            <img src="<?php echo media_url() ?>/img/user2.png" alt="" class="img-u image-responsive" />
                                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <div id="blog-footer-div">
                        <div class="media">
                            <div class="pull-left">
                                <img src="<?php echo media_url() ?>/img/user2.png" class="img-circle" alt=""  />
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img src="<?php echo media_url() ?>/img/user.gif" class="img-circle" alt=""/>
                            </div>
                            <div class="media-body">
                                <span class="media-heading"><a href="blog-home.html">Pellentesque habitant morbi tristique</a></span>
